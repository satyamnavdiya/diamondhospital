...
const ObsGyne = () => {
    ...
    return (
        <div className="min-h-screen bg-white pt-32 max-[991px]:pt-[6rem] max-sm:pt-[6.5rem] ">
            ...
            <section className="relative h-[80vh] max-sm:h-[50vh] flex items-center justify-center overflow-hidden mix-blend-multiply">
                ...
                <div className="container relative z-10 text-center text-white px-4">
                    <motion.h1
                        ...
                        {...fadeInUp}
                    >
                        <span className="spec-hero-heading">Obstetric & Gynecology</span>
                    </motion.h1>
                    <motion.p
                    ...
                    >
                        <span className='spec-sub-heading'>Comprehensive Women’s Care: Compassionate Obstetric & Gynecology Services</span>
                    </motion.p>
                </div>
            </section>
                    ...
                    >
                        <div>
                            ...
                            <p className="text-gray-600 spec-text">
                                At RTSV - SDA Dimond Hospital, our Obstetrics and Gynecology Department is dedicated to providing holistic, high-quality care for women at every stage of life. From adolescence through menopause and beyond, our expert team of gynecologists and obstetricians offers personalized treatment in a supportive and respectful environment.
                                <br /><br />
                                We specialize in a full range of women’s health services—including prenatal and postnatal care, normal and high-risk pregnancy management, menstrual disorders, infertility treatment, and minimally invasive gynecological surgeries. Our modern facilities and advanced diagnostic tools ensure accurate assessments and effective treatment options tailored to each patient’s unique needs.
                                <br /><br />
                                Whether you're planning a pregnancy, managing a chronic condition, or seeking routine check-ups, RTSV - SDA Dimond Hospital is here to support your health and well-being with compassion, expertise, and the latest in women’s healthcare. Your comfort and safety are our top priorities. <b>We offer all our services at competitive prices.</b>
                            </p>
                        </div>
            ...
            {/* About Doctors */}
            <div className='w-[80%] div-center max-sm:w-[80%] '>
