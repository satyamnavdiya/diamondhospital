    ...
    return (
        <>
            <footer className='bg-[#77baab7d]'>
                <div className="w-full rounded-lg overflow-hidden sm:mr-10 p-10 pb-0 flex items-end justify-start relative div-map z-10 max-sm:hidden">
                    <iframe
                        width="100%"
                        height="100%"
                ...
                <div className='p-2 footer-div  div2-footer max-[991px]:mt-10 max-sm:pt-0 max-sm:mt-[-20px]'>
                    <h1 className='text-2xl mb-5 text-[#26362c] font-bold footer-div-heading'>Meet Us On</h1>
                    <p className='text-[#005b41] footer-text max-sm:mt-[-20px]'>Swati Society, Chikuwadi, <br />  Varachcha Road, Surat</p>
                    <br />
                    <h1 className='text-2xl mb-5 text-[#26362c] font-bold footer-div-heading'>Mail Us On</h1>
                    <p className='text-[#005b41] text-[15px] footer-text max-sm:mt-[-20px]'>admin@sdahospitalsurat.com</p>
                    <br />
                    <div className="div5-footer max-sm:mt-0">
                        ...
                        <div className='flex justify-start div-center max-sm:justify-center'>
                            ...
                            {/* facebook */}
                            <a target='_blank' href="https://www.facebook.com/diamondhospitalsurat/">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                            ...
                            {/* Youtube */}
                            <a target='_blank' href="https://www.youtube.com/@Diamondhospitalsurat">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
