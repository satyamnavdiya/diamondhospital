        ...
        <div className='spec-hero'>
            ...
            <section className="hero-sec-img relative flex items-center justify-center overflow-hidden mix-blend-multiply">
                ...
                <div className="container relative z-10 text-center text-white px-4">
                    <motion.h1
                        ...
                        {...fadeInUp}
                    >
                        <span className='spec-hero-heading'>Floor Plan</span>
                    </motion.h1>
                    <motion.p
            ...
            <section className='pt-[3rem]'>
                <div className='floor-div'>
                    <p className='w-1/2 bg-red-600 text-white text-center rounded-[7px] p-5 mr-8'>Floor</p>
                    <p className='w-1/2 bg-red-600 text-white text-center rounded-[7px] p-5'>Details</p>
                </div>

                <div className='floor-div mt-5'>
                    <div className='w-1/2 bg-[#324a75] text-white text-center rounded-[7px] p-6 mr-6'> <h1>Basement - 1</h1></div>
                ...
                <div className='floor-div mt-5'>
                    <div className='w-1/2 bg-teal-600 text-white text-center rounded-[7px] p-6   mr-6'> <h1>Ground Floor</h1></div>
                    <div className='w-1/2 bg-teal-600 text-white rounded-[7px] p-6'>
                ...
                <div className='floor-div mt-5'>
                    <div className='w-1/2 bg-[rgb(50,74,117)] text-white text-center rounded-[7px] p-6   mr-6'><h1>Second Floor</h1></div>
                    <div className='w-1/2 bg-[#324a75] text-white rounded-[7px] p-6'>
                ...
                <div className='floor-div mt-5'>
                    <div className='w-1/2 bg-teal-600 text-white text-center rounded-[7px] p-6   mr-6'><h1>Third Floor</h1></div>
                    <div className='w-1/2 bg-teal-600 text-white  rounded-[7px] p-6'>
                ...
                <div className='floor-div mt-5'>
                    <div className='w-1/2 bg-[#5e4384] text-white text-center rounded-[7px] p-6   mr-6'><h1>Forth Floor</h1></div>
                    <div className='w-1/2 bg-[#5e4384] text-white  rounded-[7px] p-6'>
