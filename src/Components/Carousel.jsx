...
const Carousel = ({ slides }) => {
    ...
    return (
        <div
            className="relative h-[500px] max-sm:h-[300px] overflow-hiddenbg-gray-800"
        ...
        >
            <AnimatePresence initial={false} custom={1}>
                <motion.div
                    ...
                    className="absolute w-full h-full max-sm:h-72 "
                >
                    <div
                        className="w-full h-full bg-cover bg-center max-sm:h-72 max-sm:mt-3"
