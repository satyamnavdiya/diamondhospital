...
const Neurology = () => {
  ...
  return (
    <div className="min-h-screen bg-white pt-32 mmax-[991px]:pt-[6rem] max-sm:pt-[6.5rem]">
      {/* Hero Section */}
          ...
          >
            <div>
              ...
              <p className="text-gray-600 spec-text">
                ...
                <br /><br />
                At RTSV - SDA Dimond Hospital, we are committed not only to treating neurological conditions but also to enhancing the overall quality of life through innovative therapies, comprehensive rehabilitation, and ongoing community support. If you or a loved one is experiencing neurological challenges, contact us today to schedule a consultation and embark on your journey toward improved neurological health.<b>We offer all our services at competitive prices.</b>
              </p>
            </div>
