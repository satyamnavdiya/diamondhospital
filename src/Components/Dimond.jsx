...
import administer from './Images/administer.jpg'
                    ...
                    <div>
                        <div className="w-full flex flex-col items-center gap-8">
                            <div className="relative">
                                <div className="chairman-img-div overflow-hidden rounded-xl border-4 border-white shadow-xl transition-transform duration-300 hover:scale-105">
                                    <img
                                        src={chairman}
                                ...
                                <div className="absolute -bottom-2 -right-0 msg-logo-div bg-white rounded-full flex items-center justify-center shadow-lg">
                            ...
                            <div>
                                <div className="mb-6">
                                    ...
                                    <p className="text-red-700 dimond-text leading-relaxed">
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        <h3 className="text-xl font-bold text-gray-900">Mr. C.P. Vanani</h3>
                                        <p className="text-gray-600">Chairman, RTSV Diamond Hospital</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div className="main-msg-div">
                    ...
                    <div className="sub-msg-div p-5 h-auto border-2 border-green-800 rounded-2xl">
                        ...
                        <div className="flex items-center justify-start gap-5 mt-5 border-b-2 border-zinc-300 p-2">
                            ...
                            <div>
                                <p className="msg-heading font-semibold">Dr. Haresh Pagda</p>
